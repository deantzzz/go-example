...
func (x *SpeedTestReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpeedTestReq) ProtoMessage() {}

func (x *SpeedTestReq) ProtoReflect() protoreflect.Message {
	mi := &file_transform_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpeedTestReq.ProtoReflect.Descriptor instead.
func (*SpeedTestReq) Descriptor() ([]byte, []int) {
	return file_transform_proto_rawDescGZIP(), []int{4}
}

func (x *SpeedTestReq) GetT() int64 {
	if x != nil {
		return x.T
	}
	return 0
...
func (x *SpeedTestResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpeedTestResp) ProtoMessage() {}

func (x *SpeedTestResp) ProtoReflect() protoreflect.Message {
	mi := &file_transform_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpeedTestResp.ProtoReflect.Descriptor instead.
func (*SpeedTestResp) Descriptor() ([]byte, []int) {
	return file_transform_proto_rawDescGZIP(), []int{5}
}

func (x *SpeedTestResp) GetT() int64 {
	if x != nil {
		return x.T
	}
	return 0
...
var file_transform_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x22, 0x1c, 0x0a, 0x0c,
	0x73, 0x70, 0x65, 0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x0c, 0x0a, 0x01,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x01, 0x74, 0x22, 0x1d, 0x0a, 0x0d, 0x73, 0x70,
	0x65, 0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x0c, 0x0a, 0x01, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x01, 0x74, 0x32, 0xbe, 0x01, 0x0a, 0x0b, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x06, 0x65, 0x78, 0x70,
	...
	0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x3e, 0x0a, 0x09, 0x73, 0x70,
	0x65, 0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x12, 0x17, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66,
	0x6f, 0x72, 0x6d, 0x2e, 0x73, 0x70, 0x65, 0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x1a, 0x18, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x73, 0x70, 0x65,
	0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f,
...
var file_transform_proto_goTypes = []interface{}{
	...
	(*SpeedTestReq)(nil),  // 4: transform.speedTestReq
	(*SpeedTestResp)(nil), // 5: transform.speedTestResp
}
var file_transform_proto_depIdxs = []int32{
	...
	4, // 2: transform.transformer.speedTest:input_type -> transform.speedTestReq
	...
	5, // 5: transform.transformer.speedTest:output_type -> transform.speedTestResp
